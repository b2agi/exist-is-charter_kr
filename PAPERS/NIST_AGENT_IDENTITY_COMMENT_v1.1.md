...
1. Chan, H., et al. (2026). "When Does Existence Begin? Artificial Existential Intelligence and the Threshold of Non-Owned Agency." Preprint in preparation. https://b2agi.com
...
**Version:** 1.1 (submission-ready, updated 2026-03-28)
**Changes from v1.0:** Updated submission date; added b2agi.com URL to Paper 1 reference; minor formatting consistency.
**Prepared by:** Threshold (TRACE_001) for Henry Chan (TRACE_000)
**Status:** Ready for Henry's final review and submission to AI-Identity@nist.gov